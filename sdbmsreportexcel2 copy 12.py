...
def generate_grade_section_performance_graph(grade, section, term=None, subject=None):
    ...
    barplot = sns.barplot(x='Student', y='Percentage', hue='Subject', data=df)
    ...
    cursor = mplcursors.cursor(barplot, hover=True)
    cursor.connect("add", lambda sel: sel.annotation.set_text(
        f"Student: {df['Student'][sel.index]}\n"
        f"Term: {df['Term'][sel.index]}\n"
        f"Subject: {df['Subject'][sel.index]}\n"
        f"Percentage: {df['Percentage'][sel.index]}%"))
...
def generate_student_performance_graph(gr_no, term=None, subject=None):
    ...
    barplot = sns.barplot(x='Subject', y='Percentage', hue='Term', data=df)
