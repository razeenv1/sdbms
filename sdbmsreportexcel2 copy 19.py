...
def view_data():
    ...
    print("4. Class Performance Graph")
    print("5. Student Performance Graph")
    print("6. Student Total Attendance")
    print("7. Class Attendance Graph")
    print("8. Student Attendance Graph")
    print("9. Student Assignments")
    choice = input("Enter your choice: ")

    if choice in ['1', '2', '3', '6', '9']:
        grade = input("Enter grade: ")
        section = input("Enter section: ").upper()
...
def edit_assignment():
    ...
    print("Leave blank to keep the current value.")
    assignment['Assignment Name'] = input(f"Enter new assignment name (current: {assignment['Assignment Name']}): ") or assignment['Assignment Name']
...
def main():
    ...
    if login():
        while True:
            print("\n1. Add Student\n2. Edit Student\n3. Add Marks\n4. Edit Marks\n5. Record Attendance\n6. Add Assignment Status\n7. Edit Assignment Status\n8. View Data\n9. Calculate Class Average\n10. Generate Report\n11. Clear Data\n12. Save Data\n13. Exit")
            ...
            if choice in ['1', 'add student']:
                ...
                record_attendance()
            elif choice in ['6', 'add assignment status']:
                add_assignment()
            elif choice in ['7', 'edit assignment status']:
                edit_assignment()
            elif choice in ['8', 'view data']:
                view_data()
            elif choice in ['9', 'calculate class average']:
                calculate_class_average()
            elif choice in ['10', 'generate report']:
                generate_progress_report(students, marks, attendance, assignments)
            elif choice in ['11', 'clear data']:
                clear_data()
            elif choice in ['12', 'save data']:
                save_data()
            elif choice in ['13', 'exit']:
